...
ifdef KERNEL_HEADERS_INSTALL
GECKO_CONFIGURE_ARGS += --with-linux-headers=$(abspath $(KERNEL_HEADERS_INSTALL))/include
endif

.PHONY: $(LOCAL_BUILT_MODULE)
$(LOCAL_BUILT_MODULE): $(TARGET_CRTBEGIN_DYNAMIC_O) $(TARGET_CRTEND_O) $(addprefix $(TARGET_OUT_SHARED_LIBRARIES)/,$(GECKO_LIB_DEPS)) $(KERNEL_HEADERS_INSTALL)
